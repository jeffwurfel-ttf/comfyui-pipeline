...
class SAM3DExportMesh:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                "output_data": ("SAM3D_MESH",),
                "format": (["obj", "glb", "ply_mesh"], {"default": "obj"}),
                "filename": ("STRING", {"default": "mesh", "multiline": False}),
                "output_dir": ("STRING", {"default": "", "multiline": False}),
                "resolution": ("INT", {"default": 512, "min": 128, "max": 2048, "step": 64}),
            }
        }
